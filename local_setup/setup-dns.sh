...
if [[ "$OSTYPE" == "darwin"* ]]; then
    ...
    echo "127.0.0.1 accelerator.mornscience.com"
    echo ""
    echo "Run this command to add the entries:"
    echo "sudo sh -c 'echo \"# Multi-Tenant System - Development\" >> /etc/hosts && echo \"127.0.0.1 rent.mornscience.com\" >> /etc/hosts && echo \"127.0.0.1 job.mornscience.com\" >> /etc/hosts && echo \"127.0.0.1 social.mornscience.com\" >> /etc/hosts && echo \"127.0.0.1 deepfake-detector.mornscience.com\" >> /etc/hosts && echo \"127.0.0.1 accelerator.mornscience.com\" >> /etc/hosts'"
    echo ""
    ...
    echo "• Accelerator: http://accelerator.mornscience.com:3001"
else
...
echo "accelerator.mornscience.com -> accelerator" 